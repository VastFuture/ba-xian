  ...
  return (
    <section className="relative overflow-hidden border-b-2 border-ink bg-jade px-5 py-20 text-paper md:px-8 md:py-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <p className="mb-5 text-xs font-black uppercase tracking-[0.35em] text-gold">{eyebrow}</p>
        ...
        <div className="mt-7 max-w-2xl text-base leading-8 text-paper/75 md:text-lg">{children}</div>
      </div>
    </section>
  );
}
